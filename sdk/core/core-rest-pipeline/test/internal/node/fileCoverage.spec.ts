...
describe("file utilities - additional coverage", function () {
  ...
  describe("createFileFromStream", function () {
    ...
    it("stream() throws when a Node.js stream is provided", function () {
      ...
      const file = createFileFromStream(nodeStreamFactory as any, "node-stream.txt");
      assert.throws(
        () => file.stream(),
    ...
    it("throws unimplemented for arrayBuffer", async function () {
      ...
      const file = createFileFromStream(streamFactory, "stream.txt");
      assert.throws(() => (file as any).arrayBuffer(), /Not implemented/);
    });
    ...
    it("throws unimplemented for text", function () {
      ...
      const file = createFileFromStream(streamFactory, "stream.txt");
      assert.throws(() => (file as any).text(), /Not implemented/);
    });
    ...
    it("throws unimplemented for slice", function () {
      ...
      const file = createFileFromStream(streamFactory, "stream.txt");
      assert.throws(() => (file as any).slice(), /Not implemented/);
    });
    ...
    it("throws unimplemented for bytes", function () {
      ...
      const file = createFileFromStream(streamFactory, "stream.txt");
      assert.throws(() => (file as any).bytes(), /Not implemented/);
    });
  });
